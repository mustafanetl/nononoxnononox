        ...
        {scene === "typing" && (
          <div className="absolute inset-0 flex items-center justify-center bg-white px-4">
            <div className="w-full text-center">
              ...
              >
                <div className="px-5 pt-5 pb-3 text-right min-h-[110px]">
                  <p className="text-lg text-foreground leading-relaxed">
                    {typedText}
                    <span className="inline-block w-0.5 h-5 bg-primary mr-0.5 animate-pulse align-middle" />
                  </p>
                </div>
        ...
        {scene === "chat" && (
          <div className="absolute inset-0 flex items-center justify-center bg-white px-4">
            <div className="w-full">
              <div className="flex justify-start mb-5 animate-promo-slide-in-right">
                <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-primary text-white px-4 py-3 text-base">
                  {PROMPT_TEXT}
                </div>
              </div>
              ...
              {[
                ...
                >
                  <div className="aspect-[3/4] relative overflow-hidden bg-muted">
                    ...
                    <div className="absolute top-2 right-2 px-2 py-0.5 rounded-md bg-white/95 backdrop-blur-sm text-[10px] font-bold text-primary uppercase tracking-wider">
                      {d.day}
                    </div>
                    <div className="absolute inset-x-2 bottom-2 text-right">
            ...
            <div className="w-full max-w-[360px] space-y-3">
              ...
              >
                <div className="aspect-[16/9] relative overflow-hidden bg-muted">
                  ...
                  />
                  <div className="absolute top-2 right-2 px-2 py-1 rounded-md bg-white/95 text-[10px] font-bold text-primary uppercase tracking-wider inline-flex items-center gap-1">
                    <Hotel className="h-3 w-3" /> فندق
                  </div>
                </div>
                <div className="p-3">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <div className="flex items-center gap-0.5 shrink-0">
                      ...
                      <span className="text-xs font-semibold">٤.٦</span>
                    </div>
                  </div>
          ...
          >
            <div className="text-center px-6">
              ...
              <p
                ...
                style={{ animationDelay: "0.5s", direction: "ltr" }}
              >
                jolliday.online
              </p>
              <p
